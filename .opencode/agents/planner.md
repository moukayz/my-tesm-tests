...
## Decision Rules
- **Important!!** Ask the user for clarification when ambiguity is obvious and affects planning (scope, success criteria, non-functional requirements, or constraints).
...
- [ ] Call Chief Tech Lead to do high-level design. Note, it's only needed when the feature is cross-end.
