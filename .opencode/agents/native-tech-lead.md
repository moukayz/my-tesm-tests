---
name: native-tech-lead
description: Creates native low-level design for C++ modules from the HLD and contracts, defines boundaries and guarantees, and specifies native test strategy.
